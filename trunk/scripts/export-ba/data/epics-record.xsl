	...
	<xsl:template match="/">    	
		...
		<body>
            ...
            <div id="sheet-box">
                ...
                <div id="image-frame">        
                    <!-- KJ/20090209: commented out link on image on request of mu
                    <a>
                ...
                <div class="infobox">
                    ...
                    <ul>
                        <li>The original copy of this image is available at 
                            ...
                            </a>. There you can order the image in a higher resolution or in another format for commercial purposes (<a href="http://ba.e-pics.ethz.ch/ba/files/General_Terms_and_Conditions_Image_Archive_ETHZ_2009.pdf">terms and conditions</a>).
                        </li>
                        <li>
            ...
            <div id="footer">
            	&copy; 2008 
                <a href="http://www.library.ethz.ch">ETH-Bibliothek</a>, <a href="http://www.ethz.ch">ETH Z&uuml;rich</a>. 
