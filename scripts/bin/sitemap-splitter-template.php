...
define("SITEMAP_TARGET_DIR", "d:/temp/sitemap-splits/");

// sitemap index file (will be overwritten!)
define("SITEMAP_INDEX_FILE", "sitemap-index.xml");
define("SITEMAP_INDEX_DIR", "d:/temp/");	

// source sitemap file (gzipped)
define("SITEMAP_SRC_FILE", "d:/temp/sitemap-ethbib-bildarchiv.xml.gz");
